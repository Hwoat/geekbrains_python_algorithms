...
#посто без рейтинга)))
#Не сам придумал данный алгоритм, но очень понравился такой вариант решения
...
if __name__ == '__main__':
    st = input('Введите непустую строку: ')
    assert len(st), 'Введена пустая строка! Перезапустите'
